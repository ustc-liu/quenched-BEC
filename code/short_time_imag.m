if (exist('OCTAVE_VERSION', 'builtin')) % Octave
  ...
  x_1 = hdf5read('short_time_imag.h5', '/1/x');
  y_1 = hdf5read('short_time_imag.h5', '/1/y');
  phit0real_1 = hdf5read('short_time_imag.h5', '/1/phit0real');
  phit0real_1 = permute(phit0real_1, ndims(phit0real_1):-1:1);
  phit0imag_1 = hdf5read('short_time_imag.h5', '/1/phit0imag');
  phit0imag_1 = permute(phit0imag_1, ndims(phit0imag_1):-1:1);
  phit1real_1 = hdf5read('short_time_imag.h5', '/1/phit1real');
  phit1real_1 = permute(phit1real_1, ndims(phit1real_1):-1:1);
  phit1imag_1 = hdf5read('short_time_imag.h5', '/1/phit1imag');
  phit1imag_1 = permute(phit1imag_1, ndims(phit1imag_1):-1:1);
end
if (exist('OCTAVE_VERSION', 'builtin')) % Octave
  load "short_time_imag.h5"
  ...
  norm_2 = hdf5read('short_time_imag.h5', '/2/norm');
  norm_2 = permute(norm_2, ndims(norm_2):-1:1);
end
