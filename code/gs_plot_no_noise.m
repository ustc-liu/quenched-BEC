...
subplot(2,2,1)
imagesc(x_1,y_1,n0);axis equal;colormap bone;colorbar
xlabel('$x$','Interpreter','latex')
ylabel('$y$','Interpreter','latex')
zlabel('n_1(x,y)')
subplot(2,2,2)
imagesc(x_1,y_1,n1);axis equal;colormap bone;colorbar
xlabel('$x$','Interpreter','latex')
ylabel('$y$','Interpreter','latex')
zlabel('n_2(x,y)')

subplot(2,2,3)
imagesc(kx,ky,abs(fftshift(phik0)).^2);axis equal;colormap bone;colorbar
